    ...
    <div className="flex min-h-screen w-full bg-[#0a0a0a] overflow-hidden font-sans">
      ...
      <div className="hidden lg:flex w-[55%] relative flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 p-16 flex flex-col h-full justify-between">
          ...
          >
            <Link href="/" className="inline-flex items-center gap-3 text-slate-400 hover:text-white transition-all group">
              ...
              <span className="text-xs font-semibold tracking-[0.2em] uppercase">Kembali</span>
            </Link>
          </motion.div>
          ...
          <div className="max-w-xl space-y-10">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8">
                ...
                <span className="text-xs font-medium tracking-wide text-slate-300">Platform Belanja Premium</span>
              </div>
              ...
              <p className="text-lg text-slate-400 leading-relaxed font-light max-w-md">
                Bergabunglah dengan ribuan pelanggan eksklusif Lumina dan nikmati pengalaman berbelanja kelas dunia.
              </p>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-white">Transaksi Aman</h4>
                  <p className="text-xs text-slate-500 mt-0.5">Enkripsi 256-bit</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-white">Akses Cepat</h4>
      ...
      <div className="flex w-full lg:w-[45%] flex-col items-center justify-center p-6 sm:p-12 relative bg-white">
        ...
        {/* Subtle background patterns for right side */}
        ...
        {/* Mobile Header */}
        <Link href="/" className="absolute top-6 left-6 lg:hidden inline-flex items-center gap-2 text-slate-500 hover:text-slate-900 transition-colors z-20">
        ...
        >
          ...
          {/* Form Wrapper - Adds extra premium shadow to Clerk's card */}
